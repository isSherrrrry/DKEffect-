...
for file in mscifile:
	...
	plot_data_final.to_csv('../Quadrant16/Quadrant16_Type2_Diagonal/Type2_16Quad_matrix_' + user_name +'.csv', encoding='utf-8')
	...
	plt.savefig('../Quadrant16/Quadrant16_Type2_Diagonal/Type2_Quad16_heatmap_' + user_name + '.png')
