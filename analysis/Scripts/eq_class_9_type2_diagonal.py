...
for file in mscifile:
	...
	plot_data_final.to_csv('../Quadrant9/Quadrant9_Type2_Diagonal/Type1_9Quad_matrix_' + user_name +'.csv', encoding='utf-8')

	plt.figure(figsize=(20,10))
	ax = sns.heatmap(plot_data_final,cmap='Blues',xticklabels=True,yticklabels=True)

	plt.savefig('../Quadrant9/Quadrant9_Type2_Diagonal/Type1_Quad9_heatmap_' + user_name + '.png')
