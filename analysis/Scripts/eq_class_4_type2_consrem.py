...
for file in mscifile:
	...
	plot_data_final.to_csv('../Quadrant4/Quadrant4_Type2_ConsRemoved/Type2_4Quad_matrix_' + user_name +'.csv', encoding='utf-8')
	plt.figure(figsize=(20,10))
	ax = sns.heatmap(plot_data_final,cmap='Blues',xticklabels=True,yticklabels=True)
	plt.savefig('../Quadrant4/Quadrant4_Type2_ConsRemoved/Type2_Quad4_heatmap_' + user_name + '.png')
