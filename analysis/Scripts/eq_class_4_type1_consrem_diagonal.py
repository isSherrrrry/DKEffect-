...
for file in mscifile:
	...
	plot_data_final.to_csv('../Quadrant4/Quadrant4_Type1_ConsRemoved_Diagonal/Type1_4Quad_matrix_' + user_name +'.csv', encoding='utf-8')

	plt.figure(figsize=(20,10))
	ax = sns.heatmap(plot_data_final,cmap='Blues',xticklabels=True,yticklabels=True)
	plt.savefig('../Quadrant4/Quadrant4_Type1_ConsRemoved_Diagonal/Type1_Quad4_heatmap_' + user_name + '.png')
