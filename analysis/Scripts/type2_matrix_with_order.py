...
for file in mscifile:
	...
	plot_data_final.to_csv('../Type2_Matrix/with_order/Type2_matrix_' + user_name +'.csv', encoding='utf-8')

	plt.figure(figsize=(20,10))
	ax = sns.heatmap(plot_data_final,cmap='Greens',xticklabels=True,yticklabels=True)
	plt.savefig('../Type2_Matrix/with_order/Type2_heatmap_' + user_name + '.png')