...
for file in mscifile:
	...
	plot_data_final.to_csv('../Quadrant16/Quadrant16_Type1/Type1_16Quad_matrix_' + user_name +'.csv', encoding='utf-8')

	plt.figure(figsize=(20,10))
	ax = sns.heatmap(plot_data_final,cmap='Blues',xticklabels=True,yticklabels=True)
	plt.savefig('../Quadrant16/Quadrant16_Type1/Type1_Quad16_heatmap_' + user_name + '.png')
