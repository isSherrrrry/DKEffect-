...
for file in mscifile:
  ...
  plot_data_final.to_csv('../Type1_Matrix/with_order/Matrix/Type1_matrix_' + user_name +'.csv', encoding='utf-8')

  plt.figure(figsize=(20,10))
  ax = sns.heatmap(plot_data_final,cmap='Blues',xticklabels=True,yticklabels=True)
  plt.savefig('../Type1_Matrix/with_order/Heatmap/Type1_heatmap_' + user_name + '.png')