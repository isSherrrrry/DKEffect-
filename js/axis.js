  ...
  var dragBarTop = svg.selectAll(".dummy")
    ...
    // .enter().append("rect")
      ...
      .call(d3.behavior.drag().on('drag', function(d,i) {
        ...
        ial.usermodel.setAttributeWeightVector(V, true, {'level': 'INFO', 'eventType': 'set_attribute_weight_vector_drag', 'whichAxis': XorY, 'userId': window.localStorage.getItem("userId"), 'data_locations': data_locations});
