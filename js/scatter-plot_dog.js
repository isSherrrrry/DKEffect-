    ...
    circle.enter().append("circle")
        ...
        .on("mouseout", function(d) {
            ...
            if (!isDragging) {
                ...
                ial.usermodel.incrementItemWeight(d, HOVER_WEIGHT, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'hover', 'elapsedTime': elapsedTime, 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'pointLocation': 'scatterplot'});
        ...
        if (activePosition != "none") {
            ...
            ial.usermodel.incrementItemWeight(d, CLICK_WEIGHT, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'click', 'classification': activePosition, 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'pointLocation': 'scatterplot'});
            //修改点
            R7Insight.log(JSON.stringify(ial.logging.peek()));
            ...
            ial.usermodel.incrementItemWeight(d, CLICK_WEIGHT, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'click', 'classification': 'none', 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'pointLocation': 'scatterplot'});
            R7Insight.log(JSON.stringify(ial.logging.peek()));
        ...
        .on("mouseup.dragend", function(d) {
            if (isDragging) {
                ...
                ial.usermodel.incrementItemWeight(d, DRAG_WEIGHT, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'drag', 'elapsedTime': elapsedTime, 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'pointLocation': 'scatterplot', 'data_locations': data_locations});
                R7Insight.log(JSON.stringify(ial.logging.peek()));
        ...
        if (self.dragged) {
                    ...
                    d3.select("#"+self.dropped).selectAll("circle").data(self.dropzone[self.dropped]).enter().append("circle")
                        ...
                        .on("mouseout", function(d) {
                            ...
                            if (!isDragging && this.parentNode != null) { // make sure it hasn't been removed from the bin since mouseover began
                                ...
                                //delete data_location*
                                ial.usermodel.incrementItemWeight(d, HOVER_WEIGHT, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'hover', 'elapsedTime': elapsedTime, 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'pointLocation': whichBin, 'data_locations': data_locations});
                        ...
                        .on("dblclick", function(d) {
                            ...
                            //delete data_location
                            ial.usermodel.incrementItemWeight(d, DOUBLE_CLICK_WEIGHT, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'double_click', 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'pointLocation': whichBin});
                            R7Insight.log(JSON.stringify(ial.logging.peek()));
            ...
            if (self.dropped=="XL" || self.dropped=="XH") {
                if (isDragging) {
                    ...
                    // log the drag with IAL
                    ial.usermodel.incrementItemWeight(self.dragged, DRAG_WEIGHT, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'drag', 'bin': self.dropped, 'elapsedTime': elapsedTime, 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'data_locations': data_locations});
                    R7Insight.log(JSON.stringify(ial.logging.peek()));
...
updategraph = function(axistobeupdated,givenV,givenVchanged) {
    ...
    ial.usermodel.setAttributeWeightVector(V, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'set_attribute_weight_vector_calc', 'whichAxis': axistobeupdated, 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'data_locations': data_locations});
    // modified logging
    R7Insight.log(JSON.stringify(ial.logging.peek()));
...
updatebycb = function(axistobeupdated, selectedattr) {
    ...
    // update IAL weight vector
    ial.usermodel.setAttributeWeightVector(V2, true, {'level': 'INFO', 'taskType': 'dog', 'eventType': 'set_attribute_weight_vector_select', 'whichAxis': axistobeupdated, 'userId': window.localStorage.getItem("userId"), 'whichCondition': window.localStorage.getItem("whichCondition"), 'data_locations': data_locations});
    // modified logging
    R7Insight.log(JSON.stringify(ial.logging.peek()));
